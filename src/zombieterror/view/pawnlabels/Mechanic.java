...
/**
 *
 * Extends Pawn. Creates ReleaseMechanicPawnEvent so controler can calculate new
 * position for label
 * 
 */
public final class Mechanic extends Pawn implements MouseMotionListener, MouseListener
{
